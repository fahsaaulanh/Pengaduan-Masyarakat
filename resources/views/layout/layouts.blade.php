    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-1">Web PPDB</div>
            </a>
            ...
            <li class="nav-item {{ (request()->is('registrasi*')) ? 'active' : '' }} ">
                ...
                <div id="collapse5" class="collapse {{ (request()->is('registrasi*')) ? 'show' : '' }}" aria-labelledby="heading5" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item {{ (request()->is('registrasi*')) ? 'active' : '' }}" href="{{url('registrasi')}}">Input Registrasi</a>
                    </div>
                </div>
            </li>
